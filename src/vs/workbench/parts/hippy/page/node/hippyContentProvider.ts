...
export class HippyContentProvider implements ITextModelContentProvider, IWorkbenchContribution {
	...
	constructor(
		...
		this.textModelResolverService.registerTextModelContentProvider(Schemas.hippy, this);
	}
...
export class HippySnippetContentProvider implements ITextModelContentProvider, IWorkbenchContribution {
